...
public:
    ...
    /*! \brief
     * \a style is the style of plot with 0 being scatter plot and 1 being colormap (histogram) plot.
     */
    GTKParticleDiagWindow( GTKPlotter *plotter, const ParticleDataBase *pdb, const Geometry *geom,
