/*! \file icons.hpp
 *  \brief Header file for icons.hpp
 */
...
extern const guint8 icon_move_inline[];
extern const guint8 icon_track_inline[];
extern const guint8 icon_zoom_fit_inline[];
extern const guint8 icon_zoom_in_inline[];
