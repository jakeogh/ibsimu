...
void ParticleDataBase2DImp::build_trajectory_density_field( ScalarField &tdens ) const
{
    tdens.clear();
...
void ParticleDataBaseCylImp::build_trajectory_density_field( ScalarField &tdens ) const
{
    tdens.clear();
...
void ParticleDataBase3DImp::add_tdens_from_segment( ScalarField &tdens, double IQ,
...
void ParticleDataBase3DImp::build_trajectory_density_field( ScalarField &tdens ) const
{
    tdens.clear();
